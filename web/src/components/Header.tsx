  ...
  return (
    <header className="w-full py-6 px-8 flex items-center justify-between">
      ...
      <nav className="flex items-center gap-4">
        <a href="#" className="text-gray-600 hover:text-emerald-600 transition-colors font-medium text-sm">使用指南</a>
        <a href="#" className="text-gray-600 hover:text-emerald-600 transition-colors font-medium text-sm">订阅套餐</a>
        ...
        {loading ? null : user ? (
          <div className="flex items-center gap-3">
            ...
            <Link href="/account" className="text-sm text-gray-700 hover:text-emerald-600 transition-colors">
              {user.email}
            </Link>
            <button
              onClick={logout}
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="px-4 py-2 text-sm text-gray-600 hover:text-emerald-600 transition-colors font-medium"
            >
              登录
            </Link>
            <Link
